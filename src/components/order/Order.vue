  ...
  <div>
    ...
    <el-card>
      ...
      <el-table :data="orderList" border stripe>
        ...
        <!-- 分页区域 -->
        <el-pagination @size-change="handleSizeChange" :page-sizes="[5, 10, 15]"
          @current-change="handleCurrentChange" :page-size="queryInfo.pagesize"
          layout="total, sizes, prev, pager, next, jumper"
          :total="total" :current-page="queryInfo.pagenum">
        </el-pagination>
    </el-card>
      <!-- 修改地址的对话框 -->
      ...
      <!-- 展示物流进度的对话框 -->
      <el-dialog width="50%" :visible.sync="progressVisible" title="物流进度">
        <el-timeline>
