<template>
  <div>
    ...
    <el-card>
      ...
      :page-sizes="[3, 5, 6, 10]" :page-size="queryInfo.pagesize"
      ...
      @close="addCateDialogClose">
        ...
        :rules="addCateFormRules">
          ...
          <el-form-item label="父级分类">
            <!-- options指定数据源 -->
            <!-- props用指配置对象 -->
            <el-cascader v-model="selectedKeys" @change="parentCateChanged"
            :options="parentCateList" :props="{ expandTrigger: 'hover',value: 'cat_id', label: 'cat_name', children: 'children',checkStrictly: 'true' }" clearable></el-cascader>
          </el-form-item>
        </el-form>
